...
const PoliCard = ({ poli, layout = 'multi', isSmall = false }) => {
  ...
  let cardClass = "bg-white rounded-xl custom-shadow overflow-hidden transform hover:scale-[1.02] transition-all duration-300";
  let headerClass = "gradient-header text-white py-4 px-5";
  let contentClass = "p-4 text-center card-gradient";
  let titleSize = "text-2xl";
  let nameSize = "text-2xl";
  let regSize = "text-5xl";
  let emptyIconSize = "text-5xl";
  let patientMargin = "mb-4";
  let regMargin = "mt-4";
  let doctorMargin = "mt-4";
  let emptyMargin = "py-12";
  
  // Sesuaikan tampilan berdasarkan jenis layout
  if (layout === 'single') {
    headerClass = "gradient-header text-white py-5 px-6";
    contentClass = "p-6 text-center card-gradient";
    titleSize = "text-2xl";
    nameSize = "text-2xl";
    regSize = "text-6xl";
    emptyIconSize = "text-6xl";
    patientMargin = "mb-5";
    regMargin = "mt-6";
    doctorMargin = "mt-5";
    emptyMargin = "py-16";
